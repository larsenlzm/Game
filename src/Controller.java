...
public class Controller {
    ...
    private void createContent(int P, int E, int L) {
        ...
        //bane5
        maps.add(new Level(50,650,1210,50,"res/spillbg1.png"));
        maps.get(4).addWalls(new Wall("res/wall1.png",1150,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1100,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1150,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1100,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1150,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1100,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1150,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1100,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1150,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1100,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1150,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",1100,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",950,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",900,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",950,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",900,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",950,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",900,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",950,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",900,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",950,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",900,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",950,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",900,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",750,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",700,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",750,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",700,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",750,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",700,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",750,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",700,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",750,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",700,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",750,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",700,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",550,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",500,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",550,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",500,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",550,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",500,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",550,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",500,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",550,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",500,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",550,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",500,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",350,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",300,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",350,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",300,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",350,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",300,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",350,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",300,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",350,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",300,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",350,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",300,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",150,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",100,180, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",150,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",100,130, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",150,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",100,380, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",150,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",100,330, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",150,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",100,580, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",150,530, gameRoot));
        maps.get(4).addWalls(new Wall("res/wall1.png",100,530, gameRoot));
